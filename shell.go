...
func shellHelp() {
	fmt.Println(`
	    the exmaple : gorm reverse mysql user:'password'@'(192.168.126.72:3306)/ztkposbackend?charset=utf8' 'templates\\goxorm'
...
func runShell(cmd *Command, args []string) {
	if len(args) != 2 {
		fmt.Println("params error, please see gorm help shell")
		return
	}
